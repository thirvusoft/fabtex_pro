...
def get_columns(invoice_list, additional_table_columns):
	...
	columns = [
		...
		_("Supplier") + "::150",
		# _("GSTIN") + "::200",
		{"fieldname": "supplier_gstin", "label": _("GSTIN"), "fieldtype": "Data", "width": 180},
		# _("Supplier Name") + "::120",
	]
...
def get_conditions(filters):
	...
	# Customized By Thirvusoft
	# Start
	if filters.get("ts_purchase_invoice_group"):
		conditions += " and ts_purchase_invoice_group = %(ts_purchase_invoice_group)s"
...
def get_invoices(filters, additional_query_columns):
	...
	return frappe.db.sql(
		"""
		select
			name, posting_date, credit_to, supplier,supplier_gstin, supplier_name, tax_id, bill_no, bill_date,
