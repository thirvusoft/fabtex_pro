...
class Gstr1Report(object):
    ...
    def get_row_data_for_invoice(self, invoice, invoice_details, tax_rate, items):
        ...
        for column in self.other_columns:
            ...
            ts_cgst_amount = 0
            ts_igst_amount = 0
            sales_doc = frappe.get_doc("Sales Invoice",invoice_details.get("invoice_number"))
    ...
    def get_columns(self):
        ...
        if self.filters.get("type_of_business") == "B2B":
            self.invoice_columns = [
                ...
                {"fieldname": "posting_date", "label": "Invoice date", "fieldtype": "Data", "width": 80, "hidden": 1},
                # End
                {
                ...
                {"fieldname": "gst_category", "label": "Invoice Type", "fieldtype": "Data", "hidden": 1},
                {
            ...
            self.invoice_columns = [
                # Customized By Thirvusoft
                # Start
                {"fieldname": "export_type", "label": "Export Type", "fieldtype": "Data", "width": 120, "hidden": 1},
